//yaga 2024 mar
// This was a quick-and-dirty script for use with Yaga and the version
...
var load_codes = function() {
  ...
  var itm_num = itm_url_split[5];
  var img_urls = [];
  var pics = document.getElementsByClassName("MuiGrid-container MuiGrid-item")[0].getElementsByTagName("img");
  if (pics.length > 0){
  ...
  if (img_urls.length > 0){
    ...
    for (var i=0; i<img_urls.length; i++){
      ...
      var download_name = "yaga " + itm_num + " ";
    ...
    if ( document.getElementById("toggle_custom_commands_button") === null ){
      ...
      var listing_info = document.getElementsByClassName("MuiGrid-container MuiGrid-item")[1];
