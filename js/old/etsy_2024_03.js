//etsy 2024 mar
// This was a quick-and-dirty script for use with Etsy and the version
...
var load_codes = function() {
  ...
  var itm_num = itm_url_split[4] + " " + itm_url_split[5];
  var img_urls = [];
  var pics = document.getElementsByClassName("listing-page-image-carousel-component")[0].getElementsByClassName("carousel-image");
  if (pics.length > 0){
  ...
  if (img_urls.length > 0){
    for (var i=0; i<img_urls.length; i++){
      ...
      img_urls[i] = img_urls[i].replace(/\/d\//,"/r/");
    }
    ...
    for (var i=0; i<img_urls.length; i++){
      ...
      var download_name = "etsy " + itm_num + " ";
    ...
    if ( document.getElementById("toggle_custom_commands_button") === null ){
      ...
      var listing_info = document.getElementById("listing-page-cart");
